...
enum parameters {ELEMENT_LENGTH,INCOGA,INCOGB,INCOGLAMBDA,INCOGC,INCOGD,INCOGALFA,INCOGF,INCOGG};
...
class mesh{
    ...
    public:
        void setParameters(float l,float A,float B,float LAMBDA,float C,float D,float ALFA,float F,float G){
            parameters[ELEMENT_LENGTH]=l;
            parameters[INCOGA]=A;
            parameters[INCOGB]=B;
            parameters[INCOGLAMBDA]=LAMBDA;
            parameters[INCOGC]=C;
            parameters[INCOGD]=D;
            parameters[INCOGALFA]=ALFA;
            parameters[INCOGF]=F;
            parameters[INCOGG]=G;
        }
